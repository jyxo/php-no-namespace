...
class Jyxo_Time_Util
{
	 ...
	 */
	public static function nextMonth(Jyxo_Time_Time $now = null)
	{
		...
		return new Jyxo_Time_Time($date);
	}

	/**
	 * Checks if the given date is a working day.
	 *
	 * @param Jyxo_Time_Time $day Date to be checked
	 * @return boolean
	 */
	public static function isWorkDay(Jyxo_Time_Time $day)
	{
