...
class Jyxo_Shell_Client
{
	 ...
	 * @return Jyxo_Shell_Client
	 * @throws Jyxo_Shell_Exception On execution error
	 */
	public function exec($cmd, &$status = null)
	{
		...
		if (!is_resource($process)) {
			throw new Jyxo_Shell_Exception('Unable to start shell process.');
		}
		...
		if ($status !== 0) {
			throw new Jyxo_Shell_Exception(
