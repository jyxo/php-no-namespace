 ...
 * @author Matěj Humpál
 */
class Jyxo_Gettext_Parser_Item
{
	/**
	 * Msgid.
	 *
	 ...
	 * @throws Jyxo_Gettext_Parser_Exception If msgid empty
	 */
	public function __construct($chunk)
	{
		...
		if (empty($this->msgid)) {
			throw new Jyxo_Gettext_Parser_Exception('Msgid is empty which is not acceptable');
		}
	}
