 ...
 */
class Jyxo_Beholder_TestCase_Imap extends Jyxo_Beholder_TestCase
{
	/**
	 * Host.
	 *
	...
	public function run()
	{
		...
		if (!extension_loaded('imap')) {
			return new Jyxo_Beholder_Result(Jyxo_Beholder_Result::NOT_APPLICABLE, 'Extension imap missing');
		}
