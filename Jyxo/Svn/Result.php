 ...
 * @author Matěj Humpál
 */
class Jyxo_Svn_Result implements Countable, SeekableIterator
{
	 ...
	 * @throws Jyxo_Svn_Exception On invalid position
	 */
	public function seek($position)
	{
		$position = (int) $position;
		if ($position < 0 || $position > count($this->items)) {
			throw new Jyxo_Svn_Exception(sprintf('Illegal index %d', $position));
		}
