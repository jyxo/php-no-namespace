...
/**
 * Validator checking if the given value is a valid ISO 3166 country code.
 * Codes taken from  http://www.iso.org/iso/country_codes/iso_3166_code_lists/english_country_names_and_code_elements.htm
 *
 * @category Jyxo
 * @package Jyxo_Input
 ...
 * @author Jan Pěček
 */
class Jyxo_Input_Validator_IsCountryCode extends Jyxo_Input_Validator_AbstractValidator
{
	/**
