 ...
 */
class Jyxo_Input_Validator_Upload extends Jyxo_Input_Validator_AbstractValidator implements Jyxo_Input_FilterInterface, Jyxo_Input_Validator_ErrorMessage
{
	/**
	 ...
	 * @return Jyxo_Input_Validator_Upload
	 */
	 ...
	 *
	 * @param Jyxo_Input_Upload|string $file File index in the $_FILES array
	 * @return boolean
	 */
	public function isValid($file)
	{
		$valid = false;
		if (!$file instanceof Jyxo_Input_Upload) {
			$file = new Jyxo_Input_Upload($file);
		}
	 ...
	 *
	 * @param Jyxo_Input_Upload $in Uploaded file
	 * @return Jyxo_Input_Upload
	 */
