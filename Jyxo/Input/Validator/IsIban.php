 ...
 */
class Jyxo_Input_Validator_IsIban extends Jyxo_Input_Validator_AbstractValidator
{
	/**
	 * Validates a value.
	 *
	...
	public function isValid($value)
	{
		...
		if (!Jyxo_Input_Validator::isBankAccountNumber(sprintf('%s-%s/%s', $prefix, $base, $bankCode))) {
			return false;
		}
