...
class Jyxo_ErrorHandler
{
	...
	/**
	 * Jyxo_ErrorMail instance for sending fatal error emails (used by the shutdown function and error handler).
	 *
	 * @var Jyxo_ErrorMail
	 */
	 ...
	 *
	 * @param Jyxo_ErrorMail $errorMail
	 */
	public static function setErrorMail(Jyxo_ErrorMail $errorMail)
	{
