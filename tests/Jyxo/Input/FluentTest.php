...
/**
 * Test of Jyxo_Input_Fluent and chained classes.
 *
 * @copyright Copyright (c) 2005-2011 Jyxo, s.r.o.
 * @license https://github.com/jyxo/php/blob/master/license.txt
 * @author Jakub Tománek
 */
class Jyxo_Input_FluentTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Tests basic work.
	 */
	...
	public function testWalk()
	{
		...
		$input1 = new Jyxo_Input_Fluent();
		$input1
			->check($current, 'data')
				->filter('lowerCase')
				->validate('isArray');
		$input2 = new Jyxo_Input_Fluent();
		$input2
			->check($current, 'data')
				->walk()
					->filter('lowercase')
