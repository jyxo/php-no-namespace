...
/**
 * Filter tests of package Jyxo_Input
 *
 ...
 */
class Jyxo_Input_FilterTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$filter = new Jyxo_Input_Filter_LowerCase();
	...
	public function testSanitizeUrl()
	{
		...
		$filter = new Jyxo_Input_Filter_SanitizeUrl();
		...
		$actual = 'www.jyxo.cz';
		$result = Jyxo_Input_Filter_SanitizeUrl::filtrate($actual);
	 ...
	 *
	 * @param Jyxo_Input_FilterInterface $filter Filter instance
	 * @param mixed $var Input value
	 * @param mixed $expected Expected value
	 */
	private function filterTest(Jyxo_Input_FilterInterface $filter, $var, $expected)
	{
	 ...
	 * @param Jyxo_Input_FilterInterface $filter Filter instance
	 */
	private function filterArrayTest(Jyxo_Input_FilterInterface $filter)
	{
		$var = array();
		$result = $filter->filter($var);
