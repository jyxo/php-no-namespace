...
/**
 * Test of Jyxo_Input_Validator_StringLengthBetween validator.
 *
 * @copyright Copyright (c) 2005-2011 Jyxo, s.r.o.
 * @license https://github.com/jyxo/php/blob/master/license.txt
 * @author Jakub Tománek
 */
class Jyxo_Input_Validator_StringLengthBetweenTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Tests right values.
	 */
	public function testValid()
	{
		...
		foreach ($testcases as $testcase) {
			...
			$validator = new Jyxo_Input_Validator_StringLengthBetween($min, $max);
	...
	public function testInvalidMin()
	{
		...
		$validator = new Jyxo_Input_Validator_StringLengthBetween(-1, 5);
	}
	...
	{
		$this->setExpectedException('InvalidArgumentException');
		$validator = new Jyxo_Input_Validator_StringLengthBetween(0, -6);
	}
	...
	{
		$this->setExpectedException('InvalidArgumentException');
		$validator = new Jyxo_Input_Validator_StringLengthBetween(12, 6);
	}
	...
	{
		$this->setExpectedException('InvalidArgumentException');
		$validator = new Jyxo_Input_Validator_StringLengthBetween(2, 6);
		$validator->setMin(12);
	}
	...
	{
		$this->setExpectedException('InvalidArgumentException');
		$validator = new Jyxo_Input_Validator_StringLengthBetween(12, 60);
		$validator->setMax(4);
	}
}
