...
/**
 * Test for the Jyxo_XmlReader class.
 *
 * @see Jyxo_XmlReader
 ...
 */
class Jyxo_XmlReaderTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Xml processor.
	 *
	...
	{
		$this->reader = new Jyxo_XmlReader();
	 ...
	 *
	 * @see Jyxo_XmlReader::getTextValue()
	 */
