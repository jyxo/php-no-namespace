...
/**
 * Test for the Jyxo_Webdav_Client class.
 *
 * @see Jyxo_Webdav_Client
 * @copyright Copyright (c) 2005-2011 Jyxo, s.r.o.
 * @license https://github.com/jyxo/php/blob/master/license.txt
 * @author Jaroslav Hanslík
 */
class Jyxo_Webdav_ClientTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Webdav client instance.
	 *
	 * @var Jyxo_Webdav_Client
	 */
	private $client = null;
	...
	protected function setUp()
	{
		...
		$this->client = new Jyxo_Webdav_Client(array($GLOBALS['webdav']));
	...
	{
		$this->setExpectedException('Jyxo_Webdav_Exception');
		$client = new Jyxo_Webdav_Client(array('127.0.0.1:5555'));
	...
	{
		$this->setExpectedException('Jyxo_Webdav_FileNotExistException');
