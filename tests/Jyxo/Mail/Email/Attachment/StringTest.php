...
/**
 * Jyxo_Mail_Email_Attachment_String class test.
 *
 * @see Jyxo_Mail_Email_Attachment_String
 * @copyright Copyright (c) 2005-2011 Jyxo, s.r.o.
 * @license https://github.com/jyxo/php/blob/master/license.txt
 * @author Jaroslav Hanslík
 */
class Jyxo_Mail_Email_Attachment_StringTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Runs the test.
	 */
	public function test()
	{
		...
		$attachment = new Jyxo_Mail_Email_Attachment_String($content, $name, $mimeType);
